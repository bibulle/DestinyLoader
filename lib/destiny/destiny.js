            ...
            function (item, callback) {
              async.waterfall([
                  ...
                  function (item, callback) {
                    ...
                    if (itemLevel && result.characters[0].baseCharacterLevel < itemLevel) {
                      return callback(null, null);
                    }
                    //if ((item.item.displayProperties.name == "Uriel's Gift") || (item.item.displayProperties.name == "Lost Pacific Mark")) {
...
var moveItem = function (user, item, itemCanBeEquipped, characterId, moveToVault, callback) {
